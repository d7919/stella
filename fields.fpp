...
contains
  ...
  subroutine init_fields
    ...
    use fields_arrays, only: gamtot, dgamtotdr, phi_solve, phizf_solve, c_mat, theta !, gamone
    use fields_arrays, only: gamtot13, gamtot31, gamtot33, apar_denom, gamtot3, dgamtot3dr
...
!        deallocate (phi_swap)
  ...
  subroutine finish_fields
    ...
    use fields_arrays, only: gamtot, dgamtotdr, gamtot13, gamtot31, gamtot33, gamtot3, dgamtot3dr
    use fields_arrays, only: gamtot, dgamtotdr
